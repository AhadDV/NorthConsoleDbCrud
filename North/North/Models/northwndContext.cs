...
namespace North.Models
{
    public partial class northwndContext : DbContext
    {
        ...
        public virtual DbSet<CodeAcademy> CodeAcademies { get; set; } = null!;
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("server=DESKTOP-15FAUDE\\SQLEXPRESS; database=northwnd; Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CodeAcademy>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("CodeAcademy");
